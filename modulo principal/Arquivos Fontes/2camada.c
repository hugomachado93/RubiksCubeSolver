...
static int executaAlgoritmo(CUB_tppCUBO cubo, char* algoritmo) {
...
// (cubo) -> 1 | 0
static int resolvidoAcima(CUB_tppCUBO cubo) {
...
C2C_tpCondRet resolve2camada(CUB_tppCUBO cubo, char *comandos){
